...
class BBTRetrieverTest {
    ...
    private static QueryRequest makeQueryRequest(int from, int count) {
    ...
    private static HttpAsyncClient makeMockedHttpClient(int statusCode) {
    ...
    private static HttpAsyncClient makeMockedFailedHttpClient() {
        def httpClient = mock(HttpAsyncClient.class)
        when(httpClient.execute(
                any(HttpGet.class),
    ...
    private static HttpAsyncClient makeMockedCancelledHttpClient() {
        def httpClient = mock(HttpAsyncClient.class)
